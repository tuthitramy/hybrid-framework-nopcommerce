...
public class RegisterPageUI {
	...
	public static final String CONFIRM__PASSWORD_TEXTBOX = "//input[@id='ConfirmPassword']";
	public static final String REGISTER_SUCCESS_MESSAGE = "//div[@class='result']";
	public static final String REGISTER_EXISTING_EMAIL_MESSAGE = "//div[@class='message-error validation-summary-errors']//li";
